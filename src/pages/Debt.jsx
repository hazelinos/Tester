          ...
          <div className="bg-bg rounded-xl p-3 border border-border space-y-1">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-bold"
                style={{ color: debt.kind === 'debt' ? '#C92F1C' : '#146466' }}>
...
function DebtCard({ debt, onEdit, onDelete, onPay, onDeletePayment, mobile }) {
  ...
  const accentColor  = isDebt ? '#C92F1C' : '#146466';
    ...
    <div className={clsx(
      ...
      <div className="h-1.5 bg-elevated rounded-full overflow-hidden">
        <div className="h-full rounded-full transition-all"
          style={{ width: `${pct}%`, backgroundColor: isDone ? '#146466' : accentColor }} />
      </div>

      <div className="flex items-center justify-between">
        <span className="text-[10px] font-bold" style={{ color: isDone ? '#146466' : accentColor }}>
